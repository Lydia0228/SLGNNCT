...
data_path = '../../data/SL/further/total/sl2id.txt'
data = pd.read_csv(data_path, sep='\t')
save_path = '../../data/SL/fold_sl/total'
...
for fold_num, (train_index, test_index) in enumerate(kf.split(data)):
    ...
    train_data, test_valid_data = train_test_split(fold_data, test_size=0.4, random_state=27)
    valid_data, test_data = train_test_split(test_valid_data, test_size=0.5, random_state=27)

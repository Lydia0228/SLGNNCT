...
kg_path =  '../../data/SL/cancertype_data/kg2BRCA.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2BRCA.csv'

kg_save = '../../data/SL/further/BRCA/kg2id.txt'
sl_save = '../../data/SL/further/BRCA/sl2id.txt'
entity_save = '../../data/SL/further/BRCA/entity2id.txt'

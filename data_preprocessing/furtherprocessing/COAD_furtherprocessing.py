...
kg_path =  '../../data/SL/cancertype_data/kg2COAD.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2COAD.csv'

kg_save = '../../data/SL/further/COAD/kg2id.txt'
sl_save = '../../data/SL/further/COAD/sl2id.txt'
entity_save = '../../data/SL/further/COAD/entity2id.txt'

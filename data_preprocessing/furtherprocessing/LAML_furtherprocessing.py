...
kg_path =  '../../data/SL/cancertype_data/kg2LAML.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2LAML.csv'

kg_save = '../../data/SL/further/LAML/kg2id.txt'
sl_save = '../../data/SL/further/LAML/sl2id.txt'
entity_save = '../../data/SL/further/LAML/entity2id.txt'

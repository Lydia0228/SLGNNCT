...
kg_path =  '../../data/SL/cancertype_data/kg2SKCM.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2SKCM.csv'

kg_save = '../../data/SL/further/SKCM/kg2id.txt'
sl_save = '../../data/SL/further/SKCM/sl2id.txt'
entity_save = '../../data/SL/further/SKCM/entity2id.txt'

...
kg_path =  '../../data/SL/cancertype_data/kg2KIRC.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2KIRC.csv'

kg_save = '../../data/SL/further/KIRC/kg2id.txt'
sl_save = '../../data/SL/further/KIRC/sl2id.txt'
entity_save = '../../data/SL/further/KIRC/entity2id.txt'

...
kg_path =  '../../data/SL/cancertype_data/kg2OV.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2OV.csv'

kg_save = '../../data/SL/further/OV/kg2id.txt'
sl_save = '../../data/SL/further/OV/sl2id.txt'
entity_save = '../../data/SL/further/OV/entity2id.txt'

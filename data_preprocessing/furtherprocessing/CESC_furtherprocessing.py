...
kg_path =  '../../data/SL/cancertype_data/kg2CESC.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2CESC.csv'

kg_save = '../../data/SL/further/CESC/kg2id.txt'
sl_save = '../../data/SL/further/CESC/sl2id.txt'
entity_save = '../../data/SL/further/CESC/entity2id.txt'

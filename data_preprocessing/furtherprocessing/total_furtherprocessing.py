...
# Config
relation2id_path = '../../data/SL/raw/relation2id.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
kg_path =  '../../data/SL/cancertype_data/kg2cancertypes.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2cancertypes.csv'

kg_save = '../../data/SL/further/total/kg2id.txt'
sl_save = '../../data/SL/further/total/sl2id.txt'
entity_save = '../../data/SL/further/total/entity2id.txt'

relation2id = pd.read_csv(relation2id_path)
human_SL = pd.read_csv(human_sl_path)
...
#-------------------------------------------------------Create human_SL Negative Samples----------------------------------------------
...
human_SL.rename(columns={'gene_a.identifier': 'gene_a'}, inplace=True)
human_SL.rename(columns={'gene_b.identifier': 'gene_b'}, inplace=True)
human_SL.rename(columns={'type': 'label'}, inplace=True)
print('The first 10 rows of human_sl after preprocessing:')
print(human_SL[:10])
...
human_SL.to_csv(sl_save, index=False, sep='\t')

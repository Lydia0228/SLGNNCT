...
kg_path =  '../../data/SL/cancertype_data/kg2LUAD.csv'
# kg_path =  '../../data/SL/raw/kg_triplet.csv'
human_sl_path = '../../data/SL/cancertype_data/sl2LUAD.csv'

kg_save = '../../data/SL/further/LUAD/kg2id.txt'
sl_save = '../../data/SL/further/LUAD/sl2id.txt'
entity_save = '../../data/SL/further/LUAD/entity2id.txt'
